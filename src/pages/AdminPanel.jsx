...
export default function AdminPanel() {
  ...
  return (
    <div className="flex min-h-screen bg-[#f0f4f9] font-body text-ink">
      {/* Sidebar con logo oficial y pestañas curvas conectadas */}
      <aside className="w-64 shrink-0 bg-[#131b2e] text-white flex flex-col justify-between pt-6 pb-6 pl-4 pr-0 select-none z-20">
        <div>
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        ...
        <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between gap-2">
          ...
          <button
            ...
            className={`flex items-center justify-center py-1.5 px-3 rounded-xl text-xs font-semibold border transition-all ${

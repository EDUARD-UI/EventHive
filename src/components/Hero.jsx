...
export default function Hero() {
  return (
    <section className="relative px-6 sm:px-10 pt-12 sm:pt-16 pb-20 sm:pb-24 text-white overflow-hidden bg-[radial-gradient(120%_140%_at_15%_-10%,#2b9dff_0%,#007BFF_45%,#0047a8_100%)]">
      <p className="text-xs font-bold uppercase tracking-wider text-accent mb-3.5">
        ● En vivo ahora — 42 eventos esta semana
      </p>
      ...
      <p className="text-sm sm:text-base text-sky-100 max-w-md mb-7">
